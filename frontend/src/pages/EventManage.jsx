      ...
      <div className="p-6 space-y-6">
        ...
        <div>
          <div className="flex items-center gap-2 mb-3">
            ...
            <h4 className="font-semibold text-slate-900">Pay via PayPal</h4>
          </div>
        ...
        <div>
          <div className="flex items-center gap-2 mb-3">
            ...
            <h4 className="font-semibold text-slate-900">Confirm your payment</h4>
          </div>
          <p className="text-sm text-slate-600 mb-3">
            After paying, click the button below. Your QR card will be emailed to you and unlocked for printing.
          </p>
